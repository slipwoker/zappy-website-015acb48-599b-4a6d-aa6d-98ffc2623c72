    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "רימקס אדוונס קרית מלאכי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '015acb48-599b-4a6d-aa6d-98ffc2623c72',
                    name: data.name || '',
                    email: data.email || '',
